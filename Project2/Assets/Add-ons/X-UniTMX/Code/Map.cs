    ...
    public class Map {
        ...
        public void ApplyCustomProperties(GameObject gameObject, MapObject obj) {
            ...
            while (obj.HasProperty(Property_AddComponent + c)) {
                UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(gameObject, "Assets/Add-ons/X-UniTMX/Code/Map.cs (2449,17)", obj.GetPropertyAsString(Property_AddComponent + c));
                c++;
            }
            c = 1;
